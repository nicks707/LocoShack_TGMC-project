...
/**
 * Servlet implementation class FileUploadServletNew
 */
@WebServlet("/FileUploadServletNew")
public class FileUploadServletNew extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		    throws ServletException, IOException {
		        ...
		        out.println("<html>");
		        out.println("<head>");
		        out.println("<title>Servlet FileUploadServletNew</title>");
		        out.println("</head>");
		        out.println("<body>");
		        out.println("<h1>Servlet FileUploadServletNew at " + request.getContextPath () + "</h1>");
		        out.println("</body>");
		        out.println("</html>");
		 ...
		 response.setContentType("text/html;charset=UTF-8");
	        ...
	        try {
	            ...
	            if(sr==1)
	            {
	            	...
	            	response.sendRedirect("createsurvey2.jsp");
