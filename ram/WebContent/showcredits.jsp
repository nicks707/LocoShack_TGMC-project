...
<tr><td valign="top" style="padding-left:100px;">
...
%>Credits you have&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red"><%=credits %></font><br/>
Credits more/less than cutoff&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red"><%int i=Integer.parseInt(credits);out.println(5000-i); %></font>	
<%
if(i>=50000)
{	
%>
