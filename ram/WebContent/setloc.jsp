...
<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script> 
 ...
 function retreat()
 {
	 ...
	 opener.document.myform.lati.value =  document.locform.lat.value;
	 opener.document.myform.lngi.value =  document.locform.lng.value;
	 opener.document.myform.loci.value =  document.locform.address.value;
